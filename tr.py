...
page = st.sidebar.radio("Choose a Feature", [
    "Home", "Text Analysis and Creative  Response", "Chat Bot", "Social Media Post Generator", "Marketing Content Generator",
...
if __name__ == "__main__":
    user_input = "I’m feeling absolutely wonderful but a little anxious about tomorrow’s meeting."

    print("\n🔍 Rule-based Analysis:")
    basic_analysis = detect_emotion_sentiment(user_input)
    print(json.dumps(basic_analysis, indent=2))

    print("\n🤖 Gemini-powered Analysis:")
    gemini_analysis = analyze_with_gemini(user_input)
    print(json.dumps(gemini_analysis, indent=2))

    print("\n🎨 Creative Response:")
    print(generate_creative_response(user_input))
